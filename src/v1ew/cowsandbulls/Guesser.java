...
public class Guesser {
     ...
     * - для хранения состояния, в виде набора цифр, и
     * - для хранения оперативной информации и списка пар из вариантов и ответов
     */
    public Guesser() {
        digits = new Digits();
...
//        digits.print();
    ...
    public static final int DIGITS_LENGTH = 10;
}
